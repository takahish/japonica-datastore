...
from japonica_warehouse import Config, Container, FileIO, Client
...
_ = jw.execute(sql="CREATE EXTENSION IF NOT EXISTS cstore_fdw;")
_ = jw.execute(sql="CREATE SERVER IF NOT EXISTS cstore_server FOREIGN DATA WRAPPER cstore_fdw;")
...
_ = jw.execute(sql="DROP FOREIGN TABLE IF EXISTS test.customer_reviews;")
_ = jw.execute(sql="""
